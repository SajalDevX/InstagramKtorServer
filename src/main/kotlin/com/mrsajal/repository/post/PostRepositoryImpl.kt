...
class PostRepositoryImpl(
    ...
    override suspend fun getFeedPosts(userId: Long, pageNumber: Int, pageSize: Int): Response<PostsResponse> {
        ...
        val postsRows = postDao.getFeedPost(
            userId = userId,
    ...
    override suspend fun getPostByUser(
        ...
        val postsRows = postDao.getPostByUser(userId = postOwnerId, pageNumber = pageNumber, pageSize = pageSize)
